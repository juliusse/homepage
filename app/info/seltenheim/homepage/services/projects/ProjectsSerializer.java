...
public class ProjectsSerializer {
    ...
    public static Project deserialize(BasicDBObject bson) {
    ...
    public static BasicDBObject serialize(Project project) {
        final BasicDBObject document = doc("displayOnStart", project.getDisplayOnStartPage()).append("version", VERSION_PROJECT)
    ...
    private static List<ProjectType> convertToProjectTypeList(List<String> typeStrings) {
