...
import services.usertracking.DatabaseActions;
import services.usertracking.Tracking;
import services.usertracking.VisitedPage;
...
public class TrackingsController extends Controller {
    ...
    public Result index(String langKey) {
        ...
        return ok(views.html.tracking.index.render());
    }
    ...
    public Result uaByQuantityAndAppearance(String langKey) throws IOException {
        ...
        return ok(views.html.tracking.uaByQuantity.render(ranking));
    }
    ...
    public Result listSessions(String langKey,String uaFilter, long minRequests) throws IOException {
        ...
        return ok(views.html.tracking.listSessions.render(trackings));
    }
